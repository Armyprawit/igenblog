            <div class="headTitle"><i class="fa fa-youtube-play"></i> <?php echo $var['ch_username'];?> <span id="loading" class="loading"></span> <span id="setting" class="setting"></span> <div id="process"></div></div>
