            <div class="articleItem <?php if($var['ar_status'] == 0){echo'draft';}?>" onClick="Javascript:toSelectArticle(<?php echo $var['ar_id'];?>);">
              ...
              <div class="info">
                  ...
                  <div class="btn right delete" onClick="Javascript:modeListArticle(<?php echo $var['ca_id'];?>);$('#categoryMode').val('<?php echo $var['ca_id'];?>');"><i class="fa fa-folder-open"></i> <?php echo $var['ca_title'];?></div>
                  <?php
                  if($var['ar_status'] == 1){
                    ?><div class="btn left normal" onClick="Javascript:statusArticle(<?php echo $var['ar_id'];?>,<?php echo $var['ar_status'];?>);"><i class="fa fa-globe"></i> เผยแพร่</div><?php
                  }
                  else{
                    ?><div class="btn left delete" onClick="Javascript:statusArticle(<?php echo $var['ar_id'];?>,<?php echo $var['ar_status'];?>);"><i class="fa fa-file-text-o"></i> แบบร่าง</div><?php
                  }
                  ?>
