...
<div id="display">
    ...
    <div id="mainContent">
        ...
        <div class="content">
          ...
          <!-- Option -->
          <div class="option">
            <div class="item btn" onClick="Javascript:createChannel($('#username').val());"><span id="btn-loading"><i class="fa fa-plus-circle"></i></span> ช่องใหม่</div>
            <div class="search"><input type="text" class="input-text" id="username" OnKeyUp="Javascript:getMetaChannel($('#username').val());" placeholder="Youtube ID: javathailand"></div>
          </div>
