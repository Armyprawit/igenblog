...
<meta property="og:title"         content="คลิปวิดีโอ : <?php echo $setting->getSetting($dbHandle,1);?>"/>
<meta property="og:description"   content="<?php echo $setting->getSetting($dbHandle,16);?>"/>
<meta property="og:url"           content="<?php echo $setting->getSetting($dbHandle,2);?>/video.php"/>
...
<title>คลิปวิดีโอ : <?php echo $setting->getSetting($dbHandle,1);?></title>
...
<div id="mainContent">
  <div class="mainContent" id="feedDisplay">
  	<div id="title">
  		<h1>Video Clip.</h1>
  		<p><i class="fa fa-quote-left"></i> Video clip of The Day. <i class="fa fa-quote-right"></i></p>
  	</div>
    <?php $timeline->getFeedTimeline($dbHandle,'feed','normal',1,0,0,21);?>
  </div>
...
<?php
  ...
  $analytic->updatePageview($dbHandle,3);
